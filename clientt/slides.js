export default [
   ...
   
    {
        ...
        image:require('./assets/val2.png')
    },
    {
        id :'3', 
        title :'Disables',
        description :"weaken, enfeeble, debilitate, undermine, sap, cripple, disable mean to lose or cause to lose strength or vigor. weaken may imply loss of physical strength, health, soundness, or stability or of quality, intensity, or effective power. enfeeble implies a condition of marked weakness and helplessness.",
        image:require('./assets/dis.jpg')
    },
    {
        id :'4', 
        title :'Associations',
        description :"Association has to do with things that are together, whether in a formal group like the National Basketball Association or just two things that are related, like the association between dogs and parks.",
